...
public class BoardDAO {
	...
	public void regist(String writer,
		...
		try {
			...
			pstmt.executeUpdate(); // pstmt 결과를 반영 
			// Insert는 executeUpdate(), select일 때는 executeQuery()를 씀
	...
	public ArrayList<BoardDTO> getList() {
		...
		ArrayList<BoardDTO> list = new ArrayList<>(); // 1행일 때는 DTO를 담고 여러행일 때 List에 DTO타입 담기
